...
The code represents the outcome of this discussion.

Other Stetch items that we looked at are:

* styling css-in-js using glamorous.js
* directory structure of componets.
* immutably data structures (really important for react and
